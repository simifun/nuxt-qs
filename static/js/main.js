...
window.jsui = {
	www: SERVER_URL,
	uri: SERVER_URL + "/static/qsong",
	ver: '5.0',
	roll: ["1", "2"],
	ajaxpager: '5',
	url_rp: SERVER_URL + "/static/qsong/tags",
	qq_id: '917437934',
	qq_tip: 'QQ咨询'
};
		...
		if(!$('#modal-wechat').length) {
			$('body').append('\
                <div class="modal fade" id="modal-wechat" tabindex="-1" role="dialog" aria-hidden="true">\
                    <div class="modal-dialog" style="margin-top:130px;width:340px;">\
                    ...
                    <div class="modal-dialog" style="margin-top:100px">\
                        <div class="modal-content">\
                            <div class="modal-body" style="text-align:center;padding:0">\
                                <img id="imgId" style="max-width:100%" src="' + _this.data('src') + '">\
                            </div>\
                        </div>\
                    </div>\
                </div>\
...
// 						var num = _ta.find('span').html();
// 						if(num) {
// 							_ta.find('span').html(++num);
// 						}
// 					}
// 				});
// 			})
...
var lcs = new Object;
lcs.set = function(key, word) {
	localStorage.setItem(key, word);
}
lcs.get = function(key) {
