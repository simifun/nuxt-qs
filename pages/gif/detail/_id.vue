			...
			<div class="content-wrap">
				<div id="dtContent" class="content">
					...
					<div class="article-paging">
						<ul class="pagination">
							<li v-on:click="onchange(index,$event)" v-for="(item,index) in items"><a href="#">{{index+1}}</a></li>
						</ul>
					</div>
					<div class="post-actions">
						<a href="javascript:;" onclick="postlike(event)" class="post-like action action-like" v-bind:pid="article.articleId"><i
							 class="fa fa-thumbs-o-up"></i>赞(<span>{{article.niceNum}}</span>)</a>
					</div>
